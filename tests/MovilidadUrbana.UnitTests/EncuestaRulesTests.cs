...
/// </summary>
[TestFixture]
public class EncuestaRulesTests
{
    ...
    public bool NombreValido(string? nombre) => EncuestaRules.NombreValido(nombre);
    ...
    [TestCase(null, ExpectedResult = false)]
    public bool EdadValida(int? edad) => EncuestaRules.EdadValida(edad);
    ...
    [TestCase(null, ExpectedResult = false)]
    public bool DistanciaValida(double? distancia) => EncuestaRules.DistanciaValida(distancia);
    ...
    [TestCase(null, ExpectedResult = false)]
    public bool MinutosValidos(int? minutos) => EncuestaRules.MinutosValidos(minutos);

    [Test]
    [Description("El asistente tiene tres pasos, y de ese número dependen la barra de progreso y el indicador")]
    public void TotalDePasos() => Assert.That(EncuestaRules.TotalDePasos, Is.EqualTo(3));
}
