namespace WebBlazor.Login.E2ETests;
...
/// </remarks>
public abstract class SurfaceTestBase : PageTest
{
    ...
    protected const string Identifier = "admin";
    ...
    /// lo escucha nadie.
    /// </summary>
    protected Task WaitForOpenCircuitAsync() =>
