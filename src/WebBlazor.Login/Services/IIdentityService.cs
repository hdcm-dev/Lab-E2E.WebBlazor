...
public interface IIdentityService
{
    ...
    AuthenticationResult Authenticate(string? identificador, string? secreto);
}
...
public sealed record AuthenticationResult(bool Aceptado, string Code, ClaimsPrincipal? Principal = null);
