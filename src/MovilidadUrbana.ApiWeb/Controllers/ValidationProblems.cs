...
{
    public static ValidationProblemDetails De(IReadOnlyDictionary<string, string> errors, string? titulo = null)
    {
        var detalles = new ValidationProblemDetails(errors.ToDictionary(e => e.Key, e => new[] { e.Value }))
        {
